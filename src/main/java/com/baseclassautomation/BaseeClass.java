package com.baseclassautomation;
...
public class BaseeClass {
	...
	public static WebDriver browserLaunch(String browser) {
		if (browser.equalsIgnoreCase("CHROME")) {
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\ranjithrekha\\eclipse-workspace-new\\Cucumber_Automation1\\Driver\\chromedrivernew.exe");
	...
	//wait methods
    //Implicitly Wait 
      public static void implicitlyWaitMethod() {
	...
	// isMultiple
	public static void checkItIsMultiple(WebElement element) {
		Select s = new Select(element);
